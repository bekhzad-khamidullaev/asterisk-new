...
class CRouter {
	...
	private array $routes = [
		...
		'problem.dispatch.view'					=> [CControllerProblemDispatchView::class,					'layout.htmlpage',		'monitoring.problem.dispatch.view'],
		'problem.dispatch.view.refresh'			=> [CControllerProblemDispatchViewRefresh::class,			'layout.json',			'monitoring.problem.view.refresh'],
		'report.dispatch.api'					=> [CControllerReportDispatchApi::class,					'layout.json',			null],
		...
		'report_host_flaps.php'		=> [CLegacyAction::class, null, null],
