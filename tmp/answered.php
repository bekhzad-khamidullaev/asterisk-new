...
$total_duration_print = (int) ceil(array_sum($total_time2) / 60);
$average_duration = ($total_calls_print > 0) ? (int) ceil(array_sum($total_time2) / $total_calls_print) : 0;
$average_hold = ($total_calls_print > 0) ? (int) ceil(array_sum($total_hold2) / $total_calls_print) : 0;
